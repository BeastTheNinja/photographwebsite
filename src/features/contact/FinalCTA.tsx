...
export default function FinalCTA({
    ...
    return (
        <div
            className="
        relative mx-auto mt-16 max-w-5xl overflow-hidden rounded-3xl
        bg-linear-to-br from-indigo-600 via-purple-600 to-pink-600
        p-8 text-center text-white shadow-2xl
        sm:mt-20 sm:p-10 md:p-12 lg:p-16
      "
        >
            {/* background glow */}
            ...
            <div className="relative z-10">
                ...
                <p className="mx-auto mb-10 max-w-3xl text-base leading-relaxed opacity-90 sm:text-lg md:text-xl lg:text-2xl">
                    Hver historie fortjener at blive fortalt gennem smuk billedkunst.
                    Lad os diskutere din vision!
                </p>
              ...
              sm:px-8 sm:py-3.5 md:px-10 md:py-4 md:text-lg
            "
                    >
              ...
              "
                ...
                rounded-full border-2 border-white/30
                bg-white/10 px-6 py-3
                text-base text-white opacity-90 backdrop-blur-md
                sm:px-8 sm:py-3.5 md:px-10 md:py-4 md:text-lg
              "
                        >
                            {phoneIcon} {phone || 'Telefonnummer kommer snart'}
                        </span>
                    )}
                </div>
            </div>
