...
export default function ContactCTA({ email }: ContactCTAProps) {
    return (
        <div
            className="
        rounded-3xl border border-indigo-100
      ...
      "
        >
            <h2
                className="
          mb-6 bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text
        ...
        "
            ...
            <p className="mb-8 text-base leading-relaxed text-gray-600 dark:text-gray-300 sm:text-lg">
                Book din fotosession i dag! Om det er familie, portræt eller særlig
                begivenhed, er jeg her til at fange dine vigtige øjeblikke.
            </p>
            ...
            rounded-full bg-linear-to-r from-indigo-600 to-purple-600
          ...
          "
            ...
            px-6 py-3 text-base text-indigo-700
            transition-all hover:scale-[1.02] hover:shadow-lg
            sm:px-8 sm:py-4 sm:text-lg
            dark:border-indigo-700 dark:bg-zinc-900 dark:text-indigo-300
          "
                >
                    Se priser
                </Link>
            ...
            <div className="border-t border-indigo-200 pt-8 dark:border-indigo-800">
                <h3 className="mb-4 text-lg text-gray-900 dark:text-white">
                    Foretrækker du en besked?
                </h3>

                <p className="mb-6 leading-relaxed text-gray-600 dark:text-gray-300">
                    Du kan nå mig direkte via email eller telefon. Jeg svarer typisk
                ...
                <a
                    href={`mailto:${email}`}
                    className="
            text-lg text-indigo-600 underline
            hover:text-purple-600
            dark:text-indigo-400 dark:hover:text-purple-400
          "
                >
                    Send mig en email →
                </a>
            ...
            <div className="mt-8 border-t border-indigo-200 pt-8 dark:border-indigo-800">
                <h3 className="mb-5 text-lg text-gray-900 dark:text-white">
                    Hurtig info
                </h3>
