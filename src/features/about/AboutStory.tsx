...
const PORTRAIT_BLUR_DATA_URL =
    'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMjAwIiBoZWlnaHQ9IjE0MDAiIHZpZXdCb3g9IjAgMCAxMjAwIDE0MDAiPjxyZWN0IHdpZHRoPSIxMjAwIiBoZWlnaHQ9IjE0MDAiIGZpbGw9IiNlNWU3ZWIiLz48L3N2Zz4=';
            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
                    ...
                    <div className="relative order-2 lg:order-1">
                        ...
                        <div className="absolute -inset-4 rounded-3xl bg-linear-to-r from-indigo-600 to-purple-600 blur-2xl opacity-20" />

                        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white shadow-2xl dark:bg-zinc-900">

                            <Image
                                src="/portrait/MorSelfie.jpg"
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <div className="space-y-5 text-base leading-relaxed text-gray-600 dark:text-gray-300 sm:text-lg">
                            <p>
                                Jeg arbejder ud fra Brønderslev og fotograferer mennesker, familier og begivenheder med fokus på at skabe billeder, der føles naturlige og nærværende.
                            </p>

                            <p>
                                Min tilgang er enkel: vi skal have en god oplevelse sammen, og du skal føle dig tryg hele vejen igennem. Når det sker, opstår de billeder, som man får lyst til at gemme og se igen mange år senere.
                            </p>
                        </div>
