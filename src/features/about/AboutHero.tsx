...
export default function AboutHero() {
    return (
        <section className="relative overflow-hidden pb-14 pt-12 sm:pb-16 sm:pt-14 md:pb-24 md:pt-20">
            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    {/* TITLE */}
                    <h1 className="mt-6 bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-3xl leading-tight tracking-tight text-transparent sm:text-4xl md:text-6xl lg:text-7xl">
                    ...
                    <div className="mt-8 flex flex-wrap items-center justify-center gap-3 text-sm text-gray-600 dark:text-gray-300">
                        <span className="rounded-full border border-gray-200 bg-white px-4 py-2 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
