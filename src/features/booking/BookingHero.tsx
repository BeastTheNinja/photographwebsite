...
export default function BookingHero() {
    return (
        <div className="text-center mb-12 max-w-3xl mx-auto">
            ...
            <div className="mt-6">
                <Link href="/priser" className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-white px-6 py-3 text-indigo-700 transition-all hover:shadow-lg hover:scale-105 dark:border-indigo-800 dark:bg-zinc-900 dark:text-indigo-300">
