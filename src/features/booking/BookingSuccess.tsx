        ...
        <div className="flex min-h-[70vh] items-center justify-center px-4 py-12 sm:min-h-[80vh] sm:py-16">
            <div className="text-center max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button type="button" onClick={onBookAnother} className="rounded-full bg-linear-to-r from-indigo-600 to-purple-600 px-6 py-3 text-base leading-none text-white transition-all hover:scale-105 hover:shadow-xl sm:px-8">
                        Book en ny fotosession
                    </button>
                    <Link href="/" className="rounded-full border-2 border-gray-300 px-6 py-3 text-base leading-none text-gray-700 transition-all hover:border-indigo-600 hover:text-indigo-600 sm:px-8 dark:border-zinc-600 dark:text-gray-100">
