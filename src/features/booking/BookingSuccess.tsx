            ...
            <div className="text-center max-w-2xl mx-auto">
                ...
                <div className="mb-8 rounded-2xl border border-gray-100 bg-white p-5 shadow-lg sm:p-6 dark:border-zinc-800 dark:bg-zinc-900">
                    ...
                    <div className="grid grid-cols-1 gap-4 text-left text-sm md:grid-cols-2">
                        ...
                        <div>
                            <p className="mb-1 text-gray-500">Sessionstype</p>
                            <DisplayValue value={formData.sessionType} />
                        </div>

                        <div>
                            <p className="mb-1 text-gray-500">Dato</p>
                            <DisplayValue value={formData.date} />
                        </div>

                        <div>
                            <p className="mb-1 text-gray-500">Tid</p>
                            <DisplayValue value={formData.time} />
                        </div>

                        <div>
                            <p className="mb-1 text-gray-500">Lokation</p>
                ...
                <div className="flex flex-col gap-4 justify-center sm:flex-row">
                    ...
                    <button
                        ...
                        className="rounded-full bg-linear-to-r from-indigo-600 to-purple-600 px-6 py-3 text-base text-white transition-all hover:scale-105 hover:shadow-xl sm:px-8"
                    >
                    ...
                    <Link
                        href="/"
                        className="rounded-full border-2 border-gray-300 px-6 py-3 text-base text-gray-700 transition-all hover:border-indigo-600 hover:text-indigo-600 sm:px-8 dark:border-zinc-600 dark:text-gray-100"
                    >
