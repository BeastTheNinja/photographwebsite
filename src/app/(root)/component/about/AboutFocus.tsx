...
export default function AboutFocus() {
    return (
        <section className="py-18 md:py-24 bg-white/70 dark:bg-zinc-950/50">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                        {focusAreas.map((area) => (
                            <article
                                key={area.title}
                                className="rounded-3xl border border-gray-100 bg-linear-to-br from-indigo-50 to-purple-50 p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl dark:border-zinc-800 dark:from-indigo-950 dark:to-purple-950"
                            >
